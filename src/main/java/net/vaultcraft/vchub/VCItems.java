...
public class VCItems {
    ...
    public static final ItemStack NO_ACTIVE_PERK = build(Material.THIN_GLASS, "&c&l&nNo active perk!", "&5Unlock perks by donating today!", "&5Use &e\"/buy\"&5 for more information.");
